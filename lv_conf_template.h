...
/** Shape text with the HarfBuzz library before rendering with FreeType
 *  fonts. Needed for scripts with contextual forms such as Devanagari,
 *  Bengali, Thai and Arabic. Requires the HarfBuzz library.
 */
